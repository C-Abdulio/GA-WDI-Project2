...
export default function Intro(){
  return(
    <div className = "intro">
      ...
      <article>Spider-Verse was the 2014-2015 Crossover for the Spider-Man comic series, on a multiversal level.</article>
<img />
<span>Morlun</span>, the vampiric creature that once <em>infamously killed Peter Parker</em>, is back and he's looking to wipe out anyone that wears a large spider on their chest.
 ...
 he's going for everyone, from Miles Morales and Jessica Drew in the Ultimate Marvel Universe, to May "Mayday" Parker in the Marvel Comics 2 Universe, to Spider-Ham and beyond! Can our heroes stop Morlun from succeeding or will their combined egos be enough to drive themselves crazy?
...
<p>It was followed up in Secret Wars (2015) with a self-titled series being one of the many tie-ins. This tie-in received a follow-up after the event, Web Warriors.</p>

In 2018, Marvel announced a sequel event called Spider-Geddon.

An animated film loosely based on this storyline, Spider-Man: Into the Spider-Verse, will be released in December 2018.</p>
